...
const DynamicSidebar = ({ currentSection }) => {
  ...
  const renderConfigurationMenu = () => (
    <div className="space-y-0">
      ...
      >
        <FaTachometerAlt className="h-5 w-5 mr-3" /> Dashboard
      </NavLink>
  ...
  const renderAccountingMenu = () => (
    <div className="space-y-0">
      <NavLink 
        ...
        className={({ isActive }) => `flex items-center px-3 py-3 transition font-medium border-b border-gray-200 ${HOVER_COLOR} ${isActive ? 'text-[#E78D69] font-bold bg-[#E78D69]/10 border-b-[#E78D69]' : 'text-gray-700'}`}
      >
        <FaCalculator className="h-5 w-5 mr-3" /> Overview
      </NavLink>
        ...
        {expandedSections.expenses && (
          <div className="ml-6 space-y-0">
            <NavLink 
              ...
              className={({ isActive }) => `flex items-center px-3 py-3 transition font-medium border-b border-gray-200 ${HOVER_COLOR} ${isActive ? 'text-[#E78D69] font-bold bg-[#E78D69]/10 border-b-[#E78D69]' : 'text-gray-600'}`}
            >
  ...
  const renderReportsMenu = () => (
    <div className="space-y-0">
      <NavLink 
        to="/dashboard/reports/overview" 
        className={({ isActive }) => `flex items-center px-3 py-3 transition font-medium border-b border-gray-200 ${HOVER_COLOR} ${isActive ? 'text-[#E78D69] font-bold bg-[#E78D69]/10 border-b-[#E78D69]' : 'text-gray-700'}`}
      >
        <FaChartBar className="h-5 w-5 mr-3" /> Overview
      </NavLink>
      ...
      <NavLink 
        to="/dashboard/reports/student-payments" 
        className={({ isActive }) => `flex items-center px-3 py-3 transition font-medium border-b border-gray-200 ${HOVER_COLOR} ${isActive ? 'text-[#E78D69] font-bold bg-[#E78D69]/10 border-b-[#E78D69]' : 'text-gray-700'}`}
      >
        <FaMoneyBill className="h-5 w-5 mr-3" /> Student Payments
      </NavLink>
    </div>
  );
  ...
  return (
    <aside className="w-64 bg-white text-gray-800 flex flex-col fixed h-full z-20 border-r border-gray-200 shadow-sm" style={{ top: '64px' }}>
