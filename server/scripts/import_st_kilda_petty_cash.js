...
// Marko's St Kilda petty cash transactions
const TRANSACTIONS = [
  // Opening balance via Opening Balance Equity
  {
    date: '2025-09-01',
    type: 'opening_balance',
    description: 'Opening balance - Marko petty cash St Kilda',
    amount: 17.08,
    debitAccount: '10001', // Petty Cash
    creditAccount: '30004' // Opening Balance Equity
  },
  
  // Cash Inflows (Cash → Petty Cash)
  {
    date: '2025-09-02',
    type: 'cash_inflow',
  ...
  // Expenses (Expense Account → Petty Cash)
  {
    date: '2025-09-02',
    type: 'expense',
  ...
  },
  {
    ...
    amount: 250.00,
    debitAccount: '50013', // Administrative Expenses (or could be Staff Welfare 50016)
    creditAccount: '10001'
  },
  {
    date: '2025-09-02',
...
async function main() {
  ...
  try {
    ...
    for (const txn of TRANSACTIONS) {
      ...
      transactionCount++;
      const txRef = `PC-STK-${txn.date}-${transactionCount}`;
    ...
    console.log('\n✅ Petty cash import completed successfully!');
