...
async function main() {
  ...
  try {
    console.log('Step 1: Soft-deleting all payment transactions...');
    ...
    console.log('\n✅ Duplicate payment transactions cleaned up!');
    console.log('Now you can re-import the correct student payments from the image.');
