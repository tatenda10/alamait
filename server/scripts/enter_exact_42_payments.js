...
async function enterExact42Payments() {
  const conn = await db.getConnection();
  try {
    console.log('📝 Entering the exact 42 payments from the image...\n');

    // The exact 42 payments from PAYMENT 2, PAYMENT 3, PAYMENT 4 columns
    const paymentData = [
