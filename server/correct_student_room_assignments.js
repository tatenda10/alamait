...
async function correctStudentRoomAssignments() {
  ...
  try {
    console.log('🔧 Correcting student room assignments...');
    ...
    try {
      ...
      console.log(`  Room assignments corrected: ${correctedCount}`);
      
      // Commit transaction
      await connection.commit();
      console.log('\n🎉 All student room assignments corrected and students assigned to beds!');
      
    } catch (error) {
      // Rollback transaction on error
      await connection.rollback();
      console.error('❌ Error during correction, transaction rolled back:', error.message);
      throw error;
    }
