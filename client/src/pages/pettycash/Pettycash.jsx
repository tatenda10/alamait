...
const PettyCash = () => {
  ...
  const handleCreateAccount = async (e) => {
    ...
    try {
      ...
      if (createAccountForm.password !== createAccountForm.confirm_password) {
              ...
              <form onSubmit={handleCreateAccount}>
                <div className="mb-4">
                  ...
                  <input
                    ...
                    className="w-full px-3 py-2 text-xs border border-gray-200 focus:outline-none focus:ring-1 focus:ring-blue-500"
                    placeholder="Enter username for petty cash access"
                  />
                </div>
                ...
                <div className="mb-4">
                  ...
                  <input
                    ...
                    className="w-full px-3 py-2 text-xs border border-gray-200 focus:outline-none focus:ring-1 focus:ring-blue-500"
                    placeholder="Enter password for petty cash access"
                  />
                </div>
                ...
                <div className="mb-4">
                  ...
                  <input
                    ...
                    onChange={(e) => setCreateAccountForm({...createAccountForm, confirm_password: e.target.value})}
                    className="w-full px-3 py-2 text-xs border border-gray-200 focus:outline-none focus:ring-1 focus:ring-blue-500"
