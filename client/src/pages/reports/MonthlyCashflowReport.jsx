    ...
    <div className="px-6 mt-5 py-8">
      <div className="mb-8">
        ...
        <p className="mt-1 text-xs text-gray-600">
          Monthly breakdown of cash flows from {new Date(startDate).toLocaleDateString()} to {new Date(endDate).toLocaleDateString()}
        </p>
      </div>
      ...
      {showReport && reportData && (
        <div className="bg-white border border-gray-200 overflow-x-auto">
          <div className="p-4">
            <h2 className="text-xs font-bold text-gray-900 mb-4">Cash Flow Statement</h2>
              ...
              <table className="min-w-full text-xs">
                <thead>
                  <tr className="border-b border-gray-300">
                    <th className="text-left py-2 px-3 font-semibold text-gray-700 sticky left-0 bg-white z-10">Account</th>
                    {reportData.months.map((month, idx) => (
                      <th key={idx} className="text-right py-2 px-3 font-semibold text-gray-700 min-w-[100px]">
                        {month}
                      </th>
                    ))}
                    <th className="text-right py-2 px-3 font-semibold text-gray-700 min-w-[100px] bg-gray-50">
                      FY-25
                    </th>
                  </tr>
                </thead>
                <tbody>
                  ...
                  <tr className="bg-blue-50">
                    <td colSpan={reportData.months.length + 2} className="py-2 px-3 font-bold text-gray-900">
                  ...
                  {reportData.operatingActivities.income.map((item, idx) => (
                    <tr key={`income-${idx}`} className="border-b border-gray-200">
                      <td className="py-1 px-3 text-gray-700">{item.category}</td>
                      {item.monthlyValues.map((val, mIdx) => (
                        <td key={mIdx} className="py-1 px-3 text-right text-gray-900">
                          {val > 0 ? formatCurrency(val) : ''}
                        </td>
                      ))}
                      <td className="py-1 px-3 text-right font-semibold text-gray-900 bg-gray-50">
                  ...
                  <tr className="border-b-2 border-gray-400 font-semibold">
                    <td className="py-2 px-3 text-gray-900">Total Rental Income</td>
                    ...
                    <td className="py-2 px-3 text-right text-gray-900 bg-gray-50">
                  ...
                  <tr className="border-b-2 border-gray-400 font-bold">
                    <td className="py-2 px-3 text-gray-900">Total Cash Flows from Operating Activities</td>
                  ...
                  {reportData.investingActivities.length > 0 ? (
                    ...
                    <tr>
                      <td colSpan={reportData.months.length + 2} className="py-1 px-3 text-gray-500 text-center">
                  ...
                  <tr className="border-b-2 border-gray-400 font-bold">
                    <td className="py-2 px-3 text-gray-900">Total Cash Flows From Investing Activities</td>
                  ...
                  <tr className="border-b-2 border-gray-400 font-bold">
                    <td className="py-2 px-3 text-gray-900">Total Cash Flows From Financing Activities</td>
                  ...
                  <tr className="border-b-2 border-gray-400 font-bold bg-yellow-50">
                    <td className="py-2 px-3 text-gray-900">Net increase in cash and cash equivalents</td>
                  ...
                  <tr className="border-b-2 border-gray-900 font-bold bg-blue-50">
                    <td className="py-2 px-3 text-gray-900">Cash and cash equivalents at end of period</td>
                    {reportData.cashAtEndOfPeriod.map((cash, idx) => (
                      <td key={idx} className="py-2 px-3 text-right text-gray-900">
                        {formatCurrency(cash)}
                      </td>
                  ...
                  {reportData.cashBreakdown.accounts.map((account, idx) => (
                    <tr key={`cash-${idx}`} className="border-b border-gray-200">
                      <td className="py-1 px-3 text-gray-700">{account.name}</td>
                  ...
                  <tr className="border-b-2 border-gray-400 font-bold">
                    ...
                    <td colSpan={reportData.months.length} className="py-2 px-3 text-right text-gray-500"></td>
                    <td className="py-2 px-3 text-right text-gray-900 bg-gray-50">
