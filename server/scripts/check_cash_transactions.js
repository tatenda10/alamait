...
async function main() {
  ...
  try {
    console.log('Checking Cash account transactions...');
    ...
    // Get all transactions affecting Cash account
    ...
    console.log(`\nTransactions affecting Cash account: ${transactions.length}`);
    ...
    console.log(`\nJournal entries for Cash: ${journalEntries.length}`);
    let totalDebits = 0;
    let totalCredits = 0;
