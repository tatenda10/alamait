...
async function previewStudentPortalEmail() {
  ...
  // Test student details for preview
  const testStudent = {
  ...
  console.log(`📧 Sending preview email to: ${testStudent.email}`);
  ...
  for (const { name, config } of configurations) {
    ...
    try {
        ...
        html: `
          <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; background: #ffffff;">
            ...
            <div style="padding: 40px 30px; background: #f8f9fa;">
              <h2 style="color: #333; margin-top: 0; font-size: 24px;">Hello ${testStudent.name}!</h2>
              ...
              <div style="background: #e8f5e8; padding: 25px; border-radius: 12px; margin: 25px 0; border-left: 5px solid #28a745;">
                ...
                <div style="background: white; padding: 20px; border-radius: 8px; margin: 15px 0;">
                  ...
                  <p style="margin: 0 0 20px 0; color: #dc3545; font-size: 18px; font-weight: bold; background: #f8f9fa; padding: 10px; border-radius: 4px; font-family: monospace;">${testStudent.studentId}</p>
                  
                  <p style="margin: 0 0 10px 0; color: #333; font-weight: bold;">Password:</p>
                  <p style="margin: 0; color: #dc3545; font-size: 18px; font-weight: bold; background: #f8f9fa; padding: 10px; border-radius: 4px; font-family: monospace;">${testStudent.studentId}</p>
                </div>
              </div>
      ...
      console.log(`   Check your inbox at: ${testStudent.email}`);
